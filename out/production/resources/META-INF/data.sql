insert into studentai (vardas, pavarde, el_paštas) values ('Gediminas', 'Jonaitis', 'g.jonaitis@gmail.com');
insert into studentai (vardas, pavarde, el_paštas) values ('Jonas', 'Petraitis', 'j.petraitis@gmail.com');
insert into studentai (vardas, pavarde, el_paštas) values ('Kazimiers', 'Lukšys', 'k.luksys@gmail.com');
insert into studentai (vardas, pavarde, el_paštas) values ('Rimas', 'Motuza', 'r.motuza@gmail.com');
